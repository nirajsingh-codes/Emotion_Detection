...
def plot_model_history(model_history, output_path):
    """
...
def main():
    ...
    model.compile(loss='categorical_crossentropy', optimizer=Adam(lr=args.lr, decay=1e-6), metrics=['accuracy'])
    model_info = model.fit(
        train_generator,
        steps_per_epoch=num_train // args.batch_size,
        epochs=args.epochs,
        validation_data=validation_generator,
        validation_steps=num_val // args.batch_size)
    
    plot_model_history(model_info, os.path.join(args.output_dir, 'imgs', 'accuracy_loss.png'))
...
# Commit 4 on 2025-02-04 22:53:25

# Commit 5 on 2024-11-11 22:53:25
